...
# --- CRITICAL PYTHON 3.14+ ASYNCIO EVENT LOOP CONTAINER FIX ---
try:
...
# Safe to safely import secondary external dependencies now
...
# Launch persistent listening network port thread immediately
threading.Thread(target=run_health_server, daemon=True).start()

# --- SECURITY INFRASTRUCTURE CONFIGURATIONS & PASSWORD AUTO-ESCAPE ---
API_ID = int(os.environ.get("API_ID", 0))
API_HASH = os.environ.get("API_HASH", "")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "")
MONGO_URI = os.environ.get("MONGO_URI", "")

# Automatically safe-escape special symbols inside your database password to prevent RFC parsing crashes
...
# --- PERSISTENT SECURITY MIDDLEWARE FILTER ---
